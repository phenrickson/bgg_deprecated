---
title: "Inspecting and Adjusting Ratings from Boardgamegeek.com"
...
The geek rating is the game's average plus around 1000 baseline 5.5 votes added, which serve as a prior to prevent games with few ratings from moving to the top of teh geek list.
...
## Effect of Complexity on Average Rating over Time

How has the relationship been complexity and average rating changed over time? We can plot complexity versus the average BGG rating by every year since 1970.
...
## Effect of Complexity on Geek Rating over Time
...
### Top Games with 100k Votes Added
