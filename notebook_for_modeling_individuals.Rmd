...
## Predicted Games in Collection from Resampling, `r paste(params$end_training_year-5, "-", params$end_training_year-1, sep="")`
...
## Predicted Games in Collection `r paste(params$end_training_year, "-", params$end_training_year+1, sep="")`

Examine the top games for `r paste(params$end_training_year, "-", params$end_training_year+1, sep="")`

```{r top games from preds, echo=F, warning=F, message=F}

foo$preds_table %>%
  set_caption(paste("Top Predicted Games for User,", params$end_training_year, "-", params$end_training_year+1, sep=""))


```

Interactive table for `r paste(params$end_training_year, "-", params$end_training_year+1, sep="")`
