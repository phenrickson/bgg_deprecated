...
my_caption = list(labs(caption = paste(paste("Data from boardgamegeek.com as of", as.Date("2021-10-24")),
...
train_data = load("/Users/Phil/OneDrive - AE Business Solutions/Documents/board_game_projects/samp_train_data.Rdata")
test_data = load("/Users/Phil/OneDrive - AE Business Solutions/Documents/board_game_projects/samp_test_data.Rdata")
...
foo = analyse_user(params$username,
                   train_data = samp_train_data,
                   test_data = samp_test_data)
...
```{r plot coefficients, echo=F, warning=F, message=F, fig.height=9, fig.width=10}
