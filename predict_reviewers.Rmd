...
```{r upset plot, fig.height=8, fig.width=10}
...
```{r place reviewers rahdo, message=F, fig.height=8, eval = F}
...
```{r place reviewers mark bigney, message=F, fig.height=8, eval = F}
...
```{r place reviewers watch it played, message=F, fig.height=8, eval = F}
...
```{r get coefs from the models, warning =F, fig.width=10, fig.height=8}
  ...
  arrange(desc(Mean)) %>%
    ...
    bg(., j = c("Mean", "Gyges", "mrbngr", 
              #  "NoPunInc",
                "Quinns", "rahdo", "TomVas", "WtchItPly", "ZeeGarc"),
       bg = col_func) %>%
      set_caption(paste("Highest Pr(", paste("own"), ") by Reviewer for Games Published in 2020"))
...
test_probs_with_actual %>%
  ...
  bg(., i = ~ actual == 'yes',
     bg = 'deepskyblue1') %>%
        set_caption(paste("Highest Pr(", paste("own"), ") for Games Published in 2020"))
  ...
  arrange(desc(Mean)) %>%
    ...
    bg(., j = c("Mean", "Gyges", "mrbngr", 
              #  "NoPunInc",
                "Quinns", "rahdo", "TomVas", "WtchItPly", "ZeeGarc"),
       bg = col_func) %>%
        set_caption(paste("Highest Pr(", paste("own"), ") by Reviewer for Games Published in 2021"))
  ...
  arrange(desc(Mean)) %>%
    ...
    bg(., j = c("Mean", "Gyges", "mrbngr", 
              #  "NoPunInc",
                "Quinns", "rahdo", "TomVas", "WtchItPly", "ZeeGarc"),
       bg = col_func) %>%
      set_caption(paste("Highest Pr(", paste("own"), ") by Reviewer for Games Published in 2022"))
